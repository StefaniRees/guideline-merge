...
export default function IntroOverview() {
  ...
  const quickLinks = [
    { title: 'Getting Started', description: isEN ? 'Step-by-step guide to enable the process in your repository.' : 'Passo a passo para habilitar o processo no seu repositório.', href: '/guideline-merge/docs/welcome/getting-started', color: '#639922', bg: '#EAF3DE', icon: (c) => (<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><circle cx="14" cy="14" r="13" stroke={c} strokeWidth="1.5" fill={`${c}15`}/><polygon points="11,9 20,14 11,19" fill={c}/></svg>) },
    { title: 'Core Principles', description: isEN ? 'Principles that guide decisions and quality.' : 'Princípios que direcionam decisões e qualidade.', href: '/guideline-merge/docs/welcome/core-principles', color: '#378ADD', bg: '#E6F1FB', icon: (c) => (<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="1.5" y="1.5" width="25" height="25" rx="6" stroke={c} strokeWidth="1.5" fill={`${c}15`}/><path d="M8 14h12M8 10h12M8 18h8" stroke={c} strokeWidth="1.5" strokeLinecap="round"/></svg>) },
    { title: isEN ? 'Phases' : 'Fases', description: isEN ? 'The 8 operational phases of the merge flow.' : 'As 8 fases operacionais do fluxo de merge.', href: '/guideline-merge/docs/phases', color: '#BA7517', bg: '#FAEEDA', icon: (c) => (<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="1.5" y="1.5" width="25" height="25" rx="6" stroke={c} strokeWidth="1.5" fill={`${c}15`}/><path d="M6 14h4l3-5 3 10 3-5h3" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>) },
    { title: isEN ? 'Roles' : 'Papéis', description: isEN ? 'Developer A, Developer B, and Mediator — responsibilities and handoffs.' : 'Developer A, Developer B e Mediador — responsabilidades e handoffs.', href: '/guideline-merge/docs/roles', color: '#7F77DD', bg: '#EEEDFE', icon: (c) => (<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="1.5" y="1.5" width="25" height="25" rx="6" stroke={c} strokeWidth="1.5" fill={`${c}15`}/><circle cx="10" cy="11" r="3" stroke={c} strokeWidth="1.5"/><circle cx="18" cy="11" r="3" stroke={c} strokeWidth="1.5"/><path d="M4 21c0-3 2.5-5 6-5M14 21c0-3 2.5-5 6-5" stroke={c} strokeWidth="1.5" strokeLinecap="round"/></svg>) },
    { title: isEN ? 'Artifacts' : 'Artefatos', description: isEN ? 'Traceable artifacts connecting phases, activities, and decisions.' : 'Artefatos rastreáveis que conectam fases, atividades e decisões.', href: '/guideline-merge/docs/artifacts', color: '#993556', bg: '#FBEAF0', icon: (c) => (<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="1.5" y="1.5" width="25" height="25" rx="6" stroke={c} strokeWidth="1.5" fill={`${c}15`}/><rect x="7" y="8" width="14" height="12" rx="2" stroke={c} strokeWidth="1.5"/><path d="M10 12h8M10 15h5" stroke={c} strokeWidth="1.5" strokeLinecap="round"/></svg>) },
    { title: 'Guidelines', description: isEN ? 'Quality gates and guidelines governing merge progression.' : 'Quality gates e diretrizes que governam a progressão do merge.', href: '/guideline-merge/docs/guidelines', color: '#0F6E56', bg: '#E1F5EE', icon: (c) => (<svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="1.5" y="1.5" width="25" height="25" rx="6" stroke={c} strokeWidth="1.5" fill={`${c}15`}/><path d="M14 7v7l4 4" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="14" cy="14" r="7" stroke={c} strokeWidth="1.5"/></svg>) },
  ];
